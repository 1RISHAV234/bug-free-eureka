...
var choice = quick_draw_data_set[random_no];
console.log(choice+" "+random_no);
document.getElementById("theelementoupdate").innerHTML = choice;
function setup() {
...
function check_sketch() {
    ...
    bruh = Math.floor(timer_counter/60)
    document.getElementById("time").innerHTML=bruh;
